...
function SubmissionForm() {
    ...
    if (status && status.type && status.message) return <div style={{ width: '100%', minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div>
            <a className='btn btn-link' href='#' onClick={ev => {
                ev.preventDefault()
    ...
    return (
        <div className='container-fluid'>
            <div className='row'>
                                        ...
                                        <div role="tabpanel">
                                            <ul className="nav nav-tabs" role="tablist" id="tab_list">
                                                <li role="presentation" className="nav-item">
                                                    <a className="nav-link" href="#primary_info" aria-controls="primary_info" role="tab" data-toggle="tab">Primary Information</a>
                                                </li>
                                                <li role="presentation" className="nav-item">
                                                ...
                                                <li role="presentation" className="nav-item active">
                                                    <a className="nav-link active" href="#detection_methods" aria-controls="detection_methods" role="tab" data-toggle="tab">Detection Methods</a>
                                                </li>
                                                <li role="presentation" className="nav-item">
                                            ...
                                            <div className="tab-content">
                                                <div role="tabpanel" className="tab-pane" id="primary_info">
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h4 className='mt-3 mb-2'>Test Instructions</h4>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h3 className='mt-3 mb-1'>Primary Information</h3>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="date"
                                                                    ...
                                                                    className="form-control" name="dispatch_date" defaultValue={formResults['dispatch_date'] || ''} readOnly />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                        ...
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="date"
                                                                    ...
                                                                    className="form-control" name="submission_deadline_date" defaultValue={formResults['submission_deadline_date']} readOnly />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                        ...
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    className="form-control" name="tested_by" defaultValue={formResults['tested_by'] || ''} placeholder='Jonathan Doeson' />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    className="form-control" name="reported_by" defaultValue={formResults['reported_by'] || ''} placeholder='Jonathan Doeson' />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div role="tabpanel" className="tab-pane" id="results">
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h3 className='mt-3 mb-1'>Results</h3>
                                                        </div>
                                                    </div>
                                                    <div className='row'>
                                                                                ...
                                                                                <th style={{ verticalAlign: 'middle' }} key={`${method.id}_${i}`}>
                                                                                    ...
                                                                                    {(formResults && formResults['mthd_' + method.id + '_target_' + (i + 1) + '_gn_trgt'] && formResults['mthd_' + method.id + '_target_' + (i + 1) + '_gn_trgt'] == dataDictionary['gene_option'].find(r => r.id == "other_gene_option").name) &&
                                                                                        <input type="text" onChange={(ev) => {
                                                                                            handleInputChange(ev)
                                                                                        }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={'mthd_' + method.id + '_target_' + (i + 1) + '_gn_trgt_other'} />}
                                                                                </th>
                                                                            ))
                                                                        })}
                                                                    </tr>
                                                                    ...
                                                                    {samples.map(sample => (
                                                                        <tr key={sample.id}>
                                                                            ...
                                                                            <td style={{ verticalAlign: 'middle' }}>
                                                                                <select className="form-control" style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`smpl_${sample.id}_interpretation`} onChange={(ev) => {
                                                                                    handleInputChange(ev)
                                                                                }}>
                                                                            ...
                                                                            <td style={{ verticalAlign: 'middle' }}>
                                                                                <textarea rows={1} onInput={(ev) => {
                                                                                    handleInputChange(ev)
                                                                                }} className="form-control" style={{ height: 'auto', padding: '1px 2px' }} name={`smpl_${sample.id}_remarks`} />
                                                                            </td>
                                                                        </tr>)
                                                                    )}
                                                                </tbody>
                                                ...
                                                <div role="tabpanel" className="tab-pane" id="sample_prep">
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h3 className='mt-3 mb-1'>Sample Preparation</h3>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className="row">
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
                                                                    <span style={{ display: 'flex', alignItems: 'center' }}>
                                                                        <input onChange={(ev) => {
                                                                            handleInputChange(ev)
                                                                        }} type="radio" value={true} name="heat_sample_inactivation" defaultChecked={formResults['heat_sample_inactivation'] == true} style={{ width: '16px', height: '16px' }} />
                                                                    ...
                                                                    <span style={{ display: 'flex', alignItems: 'center' }}>
                                                                        <input onChange={(ev) => {
                                                                            handleInputChange(ev)
                                                                        }} type="radio" value={false} name="heat_sample_inactivation" defaultChecked={formResults['heat_sample_inactivation'] == false} style={{ width: '16px', height: '16px' }} />
                                                        ...
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="number" onChange={(ev) => {
                                                                    handleInputChange(ev)
                                                                }} className="form-control" name="inactivation_temp" defaultValue={formResults['inactivation_temp'] || ''} placeholder='0' />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="number" onChange={(ev) => {
                                                                    handleInputChange(ev)
                                                                }} className="form-control" name="inactivation_duration" defaultValue={formResults['inactivation_duration'] || ''} placeholder='0' />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                ...
                                                <div role="tabpanel" className="tab-pane active" id="detection_methods">
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h3 className='mt-3 mb-1'>Detection Methods</h3>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <div className="table-responsive">
                                                                <table className="table table-bordered table-striped table-sm">
                                                                    <thead>
                                                                        <tr>
                                                                            <th style={{ verticalAlign: 'middle' }}>Method | Target gene(s)</th>
                                                                        ...
                                                                        {methods.map((method, mx) => {
                                                                            return <tr key={mx}>
                                                                                ...
                                                                                <td style={{ verticalAlign: 'middle' }}>
                                                                                    <select onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_conventional_realtime`} defaultValue={formResults[`detection_method_${mx + 1}_conventional_realtime`]}>
                                                                                        <option value=''>Select</option>
                                                                                ...
                                                                                <td style={{ verticalAlign: 'middle' }}>
                                                                                    <select onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_inhouse_commercial`} defaultValue={formResults[`detection_method_${mx + 1}_inhouse_commercial`]}>
                                                                                        <option value=''>Select</option>
                                                                                ...
                                                                                <td style={{ verticalAlign: 'middle' }}>
                                                                                    <select onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_assay`} defaultValue={formResults[`detection_method_${mx + 1}_assay`]}>
                                                                                        <option value=''>Select</option>
                                                                                    ...
                                                                                    <select onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control autocomplete' id="assay_2_dropdown" data-live-search="true" style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_assay`} defaultValue={formResults[`detection_method_${mx + 1}_assay`]}>
                                                                                        <option value=''>Select</option>
                                                                                ...
                                                                                <td style={{ verticalAlign: 'middle' }}>
                                                                                    <select onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_algorithm`} defaultValue={formResults[`detection_method_${mx + 1}_algorithm`]}>
                                                                                        <option value=''>Select</option>
                                                                                ...
                                                                                <td style={{ verticalAlign: 'middle' }}>
                                                                                    <textarea onChange={(ev) => {
                                                                                        handleInputChange(ev)
                                                                                    }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_${mx + 1}_remarks`} defaultValue={formResults[`detection_method_${mx + 1}_remarks`]} rows={3}></textarea>
                                                                                </td>
                                                                            </tr>
                                                                        })}
                                                                        <tr>
                                                                            ...
                                                                            <td colSpan={6} className='text-center'>
                                                                                <textarea onChange={(ev) => {
                                                                                    handleInputChange(ev)
                                                                                }} className='form-control' style={{ height: 'auto', padding: '1px 2px', fontSize: '0.85em' }} name={`detection_method_overall_remarks`} defaultValue={formResults[`detection_method_overall_remarks`]} rows={3}></textarea>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                ...
                                                <div role="tabpanel" className="tab-pane" id="molecular_detection">
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <h3 className='mt-3 mb-1'>Implementation of Molecular Detection (Questionnaire)</h3>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div className="row">
                ...
                <div className='col-md-12 p-2 rounded text-sm text-muted' style={{ backgroundColor: 'aliceblue' }}>
                    <small>
                        <details>
                            <summary>User Samples</summary>
